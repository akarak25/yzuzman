...
<<<<<<< HEAD
                {locale === 'tr' ? 'En Yeni Teknolojiler' : 'Latest Technologies'}
=======
...
>>>>>>> 4ff658e466399608fb3515ee153f73b730615225
              ...
              >
<<<<<<< HEAD
                {locale === 'tr' ? 'Projelerimizi İnceleyin' : 'View Our Projects'}
=======
...
<<<<<<< HEAD
                <div className="text-sm text-gray-600 dark:text-gray-400">{locale === 'tr' ? 'Tamamlanan Proje' : 'Completed Projects'}</div>
=======
...
<<<<<<< HEAD
                <div className="text-sm text-gray-600 dark:text-gray-400">{locale === 'tr' ? 'Müşteri Memnuniyeti' : 'Client Satisfaction'}</div>
=======
...
<<<<<<< HEAD
                <div className="text-sm text-gray-600 dark:text-gray-400">{locale === 'tr' ? 'Yıllık Tecrübe' : 'Years Experience'}</div>
=======
...
<<<<<<< HEAD
                <div className="text-sm text-gray-600 dark:text-gray-400">{locale === 'tr' ? 'Teknik Destek' : 'Technical Support'}</div>
=======
...
<<<<<<< HEAD
                      <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">{locale === 'tr' ? 'Web & Mobil Çözümler' : 'Web & Mobile Solutions'}</h3>
                      <p className="text-gray-500 dark:text-gray-300">{locale === 'tr' ? 'Modern teknolojilerle geliştirilen projeler' : 'Projects developed with modern technologies'}</p>
=======
